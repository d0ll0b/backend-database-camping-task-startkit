...
values
(
	(select id from "COACH" where user_id in (select id from "USER" where email = 'lee2000@hexschooltest.io')),
	(select id from "SKILL" where name = '重訓')
),
(
	(select id from "COACH" where user_id in (select id from "USER" where email = 'muscle@hexschooltest.io')),
	(select id from "SKILL" where name = '重訓')
),
(
	(select id from "COACH" where user_id in (select id from "USER" where email = 'muscle@hexschooltest.io')),
...
(
	(select id from "COACH" where user_id in (select id from "USER" where email = 'starplatinum@hexschooltest.io')),
	(select id from "SKILL" where name = '重訓')
),
(
	(select id from "COACH" where user_id in (select id from "USER" where email = 'starplatinum@hexschooltest.io')),
...
where user_id in (select id from "USER" where email = 'muscle@hexschooltest.io')

update "COACH" set experience_years = 5
where user_id in (select id from "USER" where email = 'starplatinum@hexschooltest.io')
